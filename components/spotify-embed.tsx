  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-black/10">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute left-2 top-[45%] z-20 h-18 w-22 -translate-y-1/2 rounded-xl object-cover shadow-soft sm:left-[86px] sm:top-[40px] sm:h-36 sm:w-40 sm:translate-y-0 lg:h-40 lg:w-44"
        loading="eager"
        decoding="async"
      />
    </div>
