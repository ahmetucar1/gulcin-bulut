...
export function InstagramEmbed({
  ...
  return (
    <div
      className={`relative h-[420px] overflow-hidden rounded-2xl border border-border/70 bg-white/70 shadow-soft ${
        className ?? ""
      }`}
    >
      <DeferredIframe
        ...
        iframeClassName="block h-[700px] w-full -mt-24 pointer-events-none"
        rootMargin="800px"
      />
      <a
        href={url}
