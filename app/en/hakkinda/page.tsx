...
export const metadata: Metadata = {
  title: "About",
  description:
    "About Psychologist Gulcin Bulut in Aydin: education, experience, and counseling approach.",
  openGraph: {
    title: "Aydin Psychologist | About",
    description:
      "About Psychologist Gulcin Bulut in Aydin: education, experience, and counseling approach."
  },
  twitter: {
...
export default function HakkindaPageEn() {
  const markdown = getAboutMarkdown("en");
    ...
    <div className="section-padding relative overflow-hidden">
      ...
      <div className="container relative grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl">Gulcin Bulut</h1>
          <p className="text-lg text-foreground/80">
            Counseling is grounded in scientific approaches, ethical principles,
            and a safe therapeutic relationship.
          </p>
